...
public partial class thlogin : System.Web.UI.Page
{
    ...
    {
        mycon.Open();
        cmd = new SqlCommand("select * from regDetail where uname='" + Login1.UserName + "' and pass='" + Login1.Password + "' and type='TH'", mycon);

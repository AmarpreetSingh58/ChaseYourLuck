<%@ Page Title="" Language="C#" MasterPageFile="~/TH/thmaster.master" AutoEventWireup="true" CodeFile="displayThQuery.aspx.cs" Inherits="TH_displayThQuery" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="text-align:center;border:hidden;column-rule-style:hidden;">
        <tr>
            <td align="center" style="color: #000000;width:200px">Select Technical Person :</td>
            <td align="center" style="width:200px;">
                <asp:DropDownList ID="DropDownList1" runat="server" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                    <asp:ListItem>-Technical Person-</asp:ListItem>
                </asp:DropDownList>
            </td>

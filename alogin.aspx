<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="alogin.aspx.cs" Inherits="alogin" %>
                ...
                <table cellpadding="1" cellspacing="0" style="border-collapse:collapse;">
                    <tr>
                        <td>
                            <table cellpadding="0">
                                <tr>
                                    <td align="center" colspan="2" style="color:#C2E565;font-weight:bold;font-size:20px;">Admin Login</td>
                                </tr>
                                <tr>
                                    <td align="center" valign="middle">
                                        <asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="UserName" ForeColor="Black">Admin Id:</asp:Label>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td align="right" colspan="2">
                                        <asp:Button ID="LoginButton" runat="server" BackColor="#A9CA6E" BorderColor="White" BorderStyle="Groove" CommandName="Login" ForeColor="White" Text="Log In" ValidationGroup="Login1" OnClick="LoginButton_Click" />
                                    </td>
                                </tr>
                            </table>
                        </td>

<%@ Page Title="" Language="C#" MasterPageFile="~/user/userMaster.master" AutoEventWireup="true" CodeFile="chpass.aspx.cs" Inherits="user_chpass" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="pass" style="padding-top:20px;">
        <table style="text-align:center; color: #000000;column-rule-style:hidden;border-style:hidden;" border="0">
            <tr>
                <td>Old Password:</td>
                <td align="center">
                    <asp:TextBox ID="TextBox3" runat="server"></asp:TextBox></td>
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBox3" ErrorMessage="*Field Can't Be Empty" Font-Size="X-Small" ForeColor="#990000"></asp:RequiredFieldValidator></td>
                </tr>
            <tr>
                <td>New Password:</td>
                <td align="center">
